    ...
    return(
        ...
        <ToastContainer/>
                    ...
                    <div className="selection">
                            <select name="category" id="category" value={inputState.category} required onChange={handleInput} >
                    ...
                    <div className="input-control">
                        <textarea name="description" value={inputState.description} placeholder="Add Description" id="description" rows="4" cols="30" onChange={handleInput}/>
                    </div>
                    <div className="mb-4">
                        <button
